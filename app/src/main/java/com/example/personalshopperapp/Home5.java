...
public class Home5 extends AppCompatActivity{
        ...
        database.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                for (DataSnapshot dataSnapshot : snapshot.getChildren()){
                    ...
                    if(PersonalShopper.getSpecialists().equalsIgnoreCase(getIntent().getStringExtra("specialty")) )
                    {
    ...
    public void logout(){
        AlertDialog.Builder alertDialog = new AlertDialog.Builder(Home5.this);
        ...
        alertDialog.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialog,int which) {
                finish();
                Toast.makeText(Home5.this,"Successfully Logged Out", Toast.LENGTH_LONG).show();
                Intent intent = new Intent(Home5.this, Login.class);
