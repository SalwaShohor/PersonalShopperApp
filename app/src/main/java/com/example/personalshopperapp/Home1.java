        ...
        database.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                for (DataSnapshot dataSnapshot : snapshot.getChildren()){
                    ...
                    if(PersonalShopper.getCity().equalsIgnoreCase(getIntent().getStringExtra("location")) &&
                       PersonalShopper.getGender().equalsIgnoreCase(getIntent().getStringExtra("gender")) &&
                       PersonalShopper.getSpecialists().equalsIgnoreCase(getIntent().getStringExtra("specialty")) )
                    {
    ...
    public void logout(){
        ...
        alertDialog.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialog,int which) {
                finish();
                Toast.makeText(Home1.this,"Successfully Logged Out", Toast.LENGTH_LONG).show();
